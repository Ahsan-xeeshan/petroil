  ...
  return (
    <div className="bg-[#1F1F1F]">
      <div className="max-w-container mx-auto">
        <div className="flex pt-[144px] pb-[170px]">
          <div className="w-5/12">
            <img src={Logo} alt="Logo" />
            <div>
              <div className="flex text-white gap-x-[5px] pt-4 items-center ">
                <svg
                ...
                <p className="font-pops text-sm">mail@yourcompany.com</p>
              </div>
              <div className="flex text-white gap-x-[5px] pt-4 items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <p className="font-pops text-sm">+896 120 5889 (Toll free)</p>
              </div>
              <div className="flex text-white gap-x-[5px] pt-4 items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <p className="font-pops text-sm">
                  101 Baker Street, New York, USA, 12345
                </p>
              </div>
            </div>
            <div className="flex gap-x-5 pt-[34px] items-center">
              <div className="bg-primary w-[29px] h-[29px] rounded-full flex items-center justify-center">
                <a href="#">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
          ...
          <div className="w-2/12">
            <h5 className="font-pops text-white font-bold text-base pt-6">
              Company
            </h5>
            <ul className="font-pops text-white pt-[21px]">
              <a href="#">
                <li className="pb-[15px] hover:pl-[5px] transition-all duration-500">
                  Home
                </li>
              </a>
              <a href="#">
          ...
          <div className="w-3/12">
            ...
            <div className="flex gap-[5px] pt-[21px]">
              <div>
                <img src={Cert1} alt="" />
              </div>
              <div>
